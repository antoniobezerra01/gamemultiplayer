        ...
        <div class="caixa-salas">
            ...
            {Object.keys(props.salas).map((key) => (
                    <div class='item-salas' key={key}>
                        ...
                        <button onClick={() => props.acessarSala(props.salas[key])}>Entrar</button>
                    </div>
                ))
            }
            ...
            <button class='btn-criar-sala' onClick={() => props.acessarSala("")}>Criar Sala</button>
            <button class='btn-atualizar-sala' onClick={() => props.acessarSala("+")}>Atualizar Lista de Salas</button>
        </div>
    );
};
