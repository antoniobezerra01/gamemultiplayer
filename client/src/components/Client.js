...
const Client = () => {
    ...
    return (
        ...
        <div>
            ...
            <Modal key="modal" show={janelaDeJogo} onClose={() => sairDoJogo()} title="Coisas a se mexer com esse modal: 1. colocar esse título com uma fonte maior e fixar esse icone de saída na direita. 2. não permitir que ele seja desativado clicando fora da tela.">
                <PingPong/>
            </Modal>
        </div>
    );
