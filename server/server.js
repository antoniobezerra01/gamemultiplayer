...
sockets.on('connection', (socket) => {
    ...
    socket.on('criarSala', function (sala) {
        ...
        socket.join(sala);
        console.log(`${socket.id} criou uma sala. [id (dono): ${jogo.salas[socket.id].idDono} | id (dono): ${jogo.salas[socket.id].idConvidado} | nome: ${jogo.salas[socket.id].nomeDaSala}],`);
